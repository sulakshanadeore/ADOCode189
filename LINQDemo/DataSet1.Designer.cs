...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        public virtual int FillByProductID(DataSet1.ProductsDataTable dataTable, global::System.Nullable<int> productid) {
        ...
        public virtual DataSet1.ProductsDataTable GetDataByProductID(global::System.Nullable<int> productid) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((productid.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[1].Value = ((int)(productid.Value));
            }
